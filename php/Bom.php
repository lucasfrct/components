    ...
    <div class="hero-unit">
      ...
      <form class="bs-docs-example form-inline">
        ...
        <div class="control-group">
          ...
          <label class="checkbox inline">
            <input type="checkbox" class="confirm" value="css" name="type_css" checked="checked">
            css
          </label>
          <label class="checkbox inline">
            <input type="checkbox" class="confirm" value="js" name="type_js" checked="checked">
            js
          </label>
          <label class="checkbox inline">
            <input type="checkbox" class="confirm" value="txt" name="type_txt" checked="checked">
            txt
          </label>
